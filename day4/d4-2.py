...
# dictionary.get(key, key에 해당하는 값이 없을 경우 return할 데이터)
...
for frame, description in ssafy['language']['python']['frameworks'].items():
    print(f'{frame}는 {description}이다')
...
print(ssafy['classes']['dj']['groups']['D'])
import random
lucky = random.choice(ssafy['classes']['dj']['groups']['D'])
